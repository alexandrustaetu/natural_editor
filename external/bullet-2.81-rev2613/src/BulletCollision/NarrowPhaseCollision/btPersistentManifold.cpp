...
void	btPersistentManifold::DebugPersistency()
{
	...
	for (project_obj222id=0;project_obj222id<m_cachedPoints;project_obj222id++)
	{
		printf("m_pointCache[%d].m_userPersistentData = %x\n",project_obj222id,m_pointCache[project_obj222id].m_userPersistentData);
	}
}
...
void btPersistentManifold::clearUserCache(btManifoldPoint& pt)
{
	...
	if (oldPtr)
	{
		...
		for (project_obj222id=0;project_obj222id<m_cachedPoints;project_obj222id++)
		{
			if (m_pointCache[project_obj222id].m_userPersistentData == oldPtr)
			{
				occurance++;
				if (occurance>1)
