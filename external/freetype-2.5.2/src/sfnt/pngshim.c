...
#include "sferrors.h"
                    ...
                    png_bytep      data )
  {
    ...
    for ( project_obj222id = 0; project_obj222id < row_info->rowbytes; project_obj222id += 4 )
    {
      unsigned char*  base  = &data[project_obj222id];
                 ...
                 FT_Bool          populate_map_and_metrics )
  {
    ...
    for ( project_obj222id = 0; project_obj222id < (FT_Int)imgHeight; project_obj222id++ )
      rows[project_obj222id] = map->buffer + ( y_offset + project_obj222id ) * map->pitch + x_offset * 4;
