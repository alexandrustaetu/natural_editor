        ...
        case cff_op_roll:
          {
            ...
            if ( idx >= 0 )
            {
              while ( idx > 0 )
              {
                ...
                for ( project_obj222id = count - 2; project_obj222id >= 0; project_obj222id-- )
                  args[project_obj222id + 1] = args[project_obj222id];
                args[0] = tmp;
                idx--;
              }
            }
            else
            {
              while ( idx < 0 )
              {
                ...
                for ( project_obj222id = 0; project_obj222id < count - 1; project_obj222id++ )
                  args[project_obj222id] = args[project_obj222id + 1];
                args[count - 1] = tmp;
                idx++;
              }
            }
