...
#define TRICK_SFNT_ID_prep  2
                ...
                FT_Parameter*  params )
  {
...

    {
      ...
      for ( project_obj222id = 0; project_obj222id < num_params && !face->unpatented_hinting; project_obj222id++ )
        if ( params[project_obj222id].tag == FT_PARAM_TAG_UNPATENTED_HINTING )
